...
```shell
yarn add -D code-consistent-husky-eslint-prettier-lint-staged prettier lint-staged husky
```

if your are using **npm**, run this command:

```shell
npm install --save-dev code-consistent-husky-eslint-prettier-lint-staged prettier lint-staged husky
```
...
```shell
yarn code-consistent-husky-eslint-prettier-lint-staged --init
```

or

```shell
npx code-consistent-husky-eslint-prettier-lint-staged --init
```
...
...
"lint-staged":{
    "src/**/*.{js,jsx,ts,tsx}": "code-consistent-husky-eslint-prettier-lint-staged --cache --fix",
